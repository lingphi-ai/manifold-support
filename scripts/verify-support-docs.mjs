...
const mustMention = {
  "README.md": ["Manifold", "docs/en", "docs/zh", "Issues", "127.0.0.1:17680", "npm run build", "v0.1.2", "Ollama", "LM Studio", "vLLM", "https://github.com/lingphi-ai/manifold-support/releases/latest", "https://www.lingphi.com/manifold/#download", "Release asset rule"],
  "docs/en/index.md": ["Manifold", "Quick start", "Support", "v0.1.2", "27", "macOS arm64", "Windows arm64", "https://github.com/lingphi-ai/manifold-support/releases/latest", "https://www.lingphi.com/manifold/#download"],
  "docs/zh/index.md": ["Manifold", "快速开始", "支持", "v0.1.2", "27 个", "macOS arm64", "Windows arm64", "https://github.com/lingphi-ai/manifold-support/releases/latest", "https://www.lingphi.com/manifold/#download"],
  "docs/en/quick-start.md": ["macOS Apple Silicon", "Windows x64", "Local CLI", "Remote", "Custom", "Ollama", "LM Studio", "vLLM", "https://github.com/lingphi-ai/manifold-support/releases/latest", "https://www.lingphi.com/manifold/#download"],
  "docs/zh/quick-start.md": ["macOS Apple Silicon", "Windows x64", "Local CLI", "Remote", "Custom", "Ollama", "LM Studio", "vLLM", "https://github.com/lingphi-ai/manifold-support/releases/latest", "https://www.lingphi.com/manifold/#download"],
  ...
  "docs/en/release-notes.md": ["v0.1.2", "v0.1.1", "Manifold-0.1.2-mac-arm64.dmg", "Manifold-0.1.2-win-x64.zip", "27 quick-add", "Ollama", "LM Studio", "vLLM", "macOS arm64", "Windows arm64", "https://github.com/lingphi-ai/manifold-support/releases/latest", "https://github.com/lingphi-ai/manifold-support/releases/tag/v0.1.2"],
  "docs/zh/release-notes.md": ["v0.1.2", "v0.1.1", "Manifold-0.1.2-mac-arm64.dmg", "Manifold-0.1.2-win-x64.zip", "27 个 quick-add", "Ollama", "LM Studio", "vLLM", "macOS arm64", "Windows arm64", "https://github.com/lingphi-ai/manifold-support/releases/latest", "https://github.com/lingphi-ai/manifold-support/releases/tag/v0.1.2"],
